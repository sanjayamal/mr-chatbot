...
This project contains source code and supporting files to setup serverless functions for mr-chatbot with the SAM CLI. It includes the following files and folders.

- lambdas - Code for the application's Lambda function.
- layers - Layers used in Lambda functions.
...
```bash
sam logs -n HelloWorldFunction --stack-name "mr-chatbot" --tail
```
...
AWS_SAM_STACK_NAME="mr-chatbot" python -m pytest tests/integration -v
```
