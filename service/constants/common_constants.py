...
chatbot_retrain_success_title = 'Bot retrained Successfully'
review_creation_success_title = 'Review Created Successfully'
...
chatbot_retrain_success_msg = 'Bot has been retrained successfully'
review_retrain_success_msg = 'Review has been created successfully'
...
get_chatbot_not_found_error_msg = 'Unable to find chatbot'
add_chat_history_error_msg = 'Unable to add history'
data_source_processing_error_msg = 'Unable to process data source'
